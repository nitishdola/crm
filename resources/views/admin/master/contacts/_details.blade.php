<div id="breadcrumb">
	...
	<ul class="tab-bar grey-tab">
		...
		<li class="{{ $oactive }}">
			<a href="#other_families" data-toggle="tab">
				<span class="block text-center">
	...
	<div class="padding-md">
		...
		<div class="tab-content">
			<div class="tab-pane fade  @if($bactive) in {{ $bactive }} @endif" id="basic">
				<div class="panel-group" id="FaqBasic2">
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<h4 class="panel-title">
								<span class="col-md-3"><i class="fa fa-bell red" aria-hidden="true"></i> Full Name </span> <span class="col-md-8 ucall"> : {{ $info->name }}</span>.
							</h4>
						</div>
					</div><!-- /panel -->
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<h4 class="panel-title">
								<span class="col-md-3"> <i class="fa fa-phone-square full-name-icon red" aria-hidden="true"></i> PHONE NUMBER </span> <span class="col-md-8 ucall">  : {{ $info->phone_number }}</span>.
							</h4>
						</div>
					</div><!-- /panel -->
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<h4 class="panel-title">
								<span class="col-md-3"> <i class="fa fa-snowflake-o full-name-icon yellow" aria-hidden="true"></i> Name of Deceased </span> <span class="col-md-8 ucall">  :  {{ $info->name_of_deceased }}</span>.
							</h4>
						</div>
					</div><!-- /panel -->
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<h4 class="panel-title">
								<span class="col-md-3"> <i class="fa fa-snowflake-o full-name-icon yellow" aria-hidden="true"></i> Deceased date of Birth </span> <span class="col-md-8 ucall">  : {{ date('d F Y', strtotime($info->deceased_dob)) }} </span>.
							</h4>
						</div>
					</div><!-- /panel -->
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<h4 class="panel-title">
								<span class="col-md-3"> <i class="fa fa-snowflake-o full-name-icon yellow" aria-hidden="true"></i> Deceased date of Death </span> <span class="col-md-8 ucall">  :  {{ date('d F Y', strtotime($info->deceased_date_of_death)) }} </span>.
							</h4>
						</div>
					</div><!-- /panel -->
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<h4 class="panel-title">
								<span class="col-md-3"> <i class="fa fa-snowflake-o full-name-icon yellow" aria-hidden="true"></i> Deceased Anniversary Date </span> <span class="col-md-8 ucall">  :  {{ date('d F Y', strtotime($info->deceased_wedding_anniversary_date)) }} </span>.
							</h4>
						</div>
					</div><!-- /panel -->
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<h4 class="panel-title">
								<span class="col-md-5"> <i class="fa fa-snowflake-o full-name-icon yellow" aria-hidden="true"></i> Other Significant Celebration </span> <span class="col-md-6 ucall">  :  {{ $info->other_significant_celebration }} </span>.
							</h4>
						</div>
					</div><!-- /panel -->
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<h4 class="panel-title">
								<span class="col-md-5"> <i class="fa fa-snowflake-o full-name-icon yellow" aria-hidden="true"></i> Other Significant Celebration Date </span> <span class="col-md-6 ucall">  : @if($info->other_significant_celebration_date) {{ date('d F Y', strtotime($info->other_significant_celebration_date)) }} @endif </span>.
							</h4>
						</div>
					</div><!-- /panel -->
			...
			<div class="tab-pane fade @if($oactive) in {{ $oactive }} @endif}" id="other_families">
				<div class="panel-group">

					@if($info->additional_family)

					@foreach($info->additional_family as $k => $v)
					<div class="panel panel-default">
						<div class="panel-heading">
							<h4 class="panel-title">
								<span class="col-md-3"><i class="fa fa-bell red" aria-hidden="true"></i> Full Name </span> <span class="col-md-8 ucall"> : {{ $v->name }}</span>.
							</h4>
						</div>
					</div><!-- /panel -->
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<h4 class="panel-title">
								<span class="col-md-3"><i class="fa fa-address-card full-name-icon green" aria-hidden="true"></i> ADDRESS </span> <span class="col-md-8 ucall">  : {{ ucwords($v->address) }} </span>.
							</h4>
						</div>
					</div><!-- /panel -->
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<h4 class="panel-title">
								<span class="col-md-3"> <i class="fa fa-phone-square full-name-icon red" aria-hidden="true"></i> PHONE NUMBER </span> <span class="col-md-8 ucall">  : {{ $v->phone_number }}</span>.
							</h4>
						</div>
					</div><!-- /panel -->
					...
					<div class="panel panel-default">
						<div class="panel-heading">
							<h4 class="panel-title">
								<span class="col-md-3"> <i class="fa fa-snowflake-o full-name-icon yellow" aria-hidden="true"></i> RELATION WITH DECEASED </span> <span class="col-md-8 ucall">  :  {{ $v->relation_with_decease }}</span>.
							</h4>
						</div>
					</div><!-- /panel -->
						...
						<div class="panel-heading">
							<h4 class="panel-title">
								<span class="col-md-3"> <i class="fa fa-snowflake-o full-name-icon yellow" aria-hidden="true"></i> CURRENT STATUS </span> <span class="col-md-8 ">  :
										@if(!$info->current_status == 'Apponintment Set')
							...
							<h4 class="panel-title">
								<span class="col-md-3"> <i class="fa fa-paper-plane blue" aria-hidden="true"></i> CHANGE STATUS </span> <span class="col-md-8 ucall">
									...
									<div class="form-group {{ $errors->has('appointment_notes') ? 'has-error' : ''}}" id="appointment_notes" style="display:none;">
											{!! Form::textarea('appointment_notes', null, ['class' => 'form-control input-sm col-md-12', 'rows' => 5, 'id' => 'appointment_notes_box', 'placeholder' => 'Appointment Notes', 'autocomplete' => 'off']) !!}
									</div>
